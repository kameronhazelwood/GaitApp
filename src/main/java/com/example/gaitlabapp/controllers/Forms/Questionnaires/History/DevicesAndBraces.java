...
public class DevicesAndBraces implements Initializable {
    public Button previousButton;
    public Button nextQuestionBut;
    public CheckBox handLed;
    ...
    public void onNextButton(ActionEvent event) throws IOException {
        ...
        fxmlLoader = new FXMLLoader(Launcher.class.getResource("/Forms/Questionnaires/History/PainInformation.fxml"));
