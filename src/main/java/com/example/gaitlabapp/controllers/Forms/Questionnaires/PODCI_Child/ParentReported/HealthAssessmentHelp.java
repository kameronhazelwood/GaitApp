...
public class HealthAssessmentHelp {
    public Button start;
    ...
    public void onStart(ActionEvent event) throws IOException {
        ...
        fxmlLoader = new FXMLLoader(Launcher.class.getResource("/Forms/Questionnaires/PODSI_Child/ParentReported/HealthAssessmentStand.fxml"));
