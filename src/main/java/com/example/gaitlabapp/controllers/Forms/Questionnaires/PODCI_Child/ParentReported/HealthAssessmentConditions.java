...
public class HealthAssessmentConditions implements Initializable {
    public Button start;
...
//        }
    ...
    public void initialize(URL location, ResourceBundle resources) {
       // JAManyTreatmentYes.selectedProperty().bind(Bindings.not(JAManyTreatmentYes.disableProperty()));
    }
}
