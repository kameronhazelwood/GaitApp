...
public class SpanishSelfReportedCompetitive {
    public Button start;

    private Stage getMyStageStart() { return (Stage) start.getScene().getWindow(); }
    public void onStart(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader;
        fxmlLoader = new FXMLLoader(Launcher.class.getResource("/Forms/Questionnaires/Spanish/SelfReported/SelfReportedCompetitivePain.fxml"));
