...
public class SpanishHealthAssessmentMissSchool {
    public Button start;
    ...
    public void onStart(ActionEvent event) throws IOException {
        ...
        fxmlLoader = new FXMLLoader(Launcher.class.getResource("/Forms/Questionnaires/Spanish/ParentReported/SpanishHealthAssessmentHappy.fxml"));
