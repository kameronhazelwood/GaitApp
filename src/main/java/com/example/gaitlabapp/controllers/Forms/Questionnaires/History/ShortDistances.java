...
public class ShortDistances implements Initializable {
    ...
    public void onNext(ActionEvent event) throws IOException {
        ...
        fxmlLoader = new FXMLLoader(Launcher.class.getResource("/Forms/Questionnaires/History/AroundClass.fxml"));
