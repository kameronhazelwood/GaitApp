...
public class VisitDetailsGaitController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        GMFCSCombo.setValue("I");
        FMS5M.setValue("6");
        FMS50M.setValue("N");
        FMS500M.setValue("6");
        GAITcomments.setText("alksndfksanfdsad;lfmasdf");
        GAITptsR.setText("3");
        ...
        PROMHipR.setText("110");
        PROMHipL.setText("115");
        ...
        PROMHipExtRotL.setText("20");
        PROMHipExtRotR.setText("20");
        PROMRyderTestR.setText("-30");
        PROMRyderTestL.setText("-30");
        PROMKneeExtR.setText("-");
        PROMKneeExtL.setText("-5");
        StrengthKneeExtR.setText("Text");
