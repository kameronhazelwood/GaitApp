...
public class ITemporalModel {
    ...
    @Column(name = "gaitDevIndexR_interp")
    private String gaitDevIndexR_interp;
    @Column(name = "gaitDevIndexL_interp")
    private String gaitDevIndexL_interp;
    @Column(name = "gaitProfScore_interp")
    private String gaitProfScore_interp;
